...
if(WIN32)
    set(OPENSSL_CRYPTO_LIBRARY "${PERICHECK_INSTALL_DIR}/lib/libcrypto-1_1.lib")  
    set(OPENSSL_SSL_LIBRARY "${PERICHECK_INSTALL_DIR}/lib/libssl-1_1.lib")
else()
    set(OPENSSL_CRYPTO_LIBRARY "${PERICHECK_INSTALL_DIR}/lib/libcrypto-1_1.a")  
    set(OPENSSL_SSL_LIBRARY "${PERICHECK_INSTALL_DIR}/lib/libssl-1_1.a")
endif()
